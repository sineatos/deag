...
func newDEBest1Statistics() support.Statistics {
...
func newDEBest1Constraint(low, up float64, evaluator benchmarks.Float64Evaluator) func(*base.Float64Individual) []float64 {
...
func newDEBest1Population(size, dims int, low, up float64) base.Individuals {
...
func TestDEBest1(t *testing.T) {
	...
	evol := NewDEBest1(f, cr, maxGen, maxFES, st, hof, evaluator)
	evol.Init(pop)
	evol.Run()
